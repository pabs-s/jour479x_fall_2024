...
```
Notes:
North Carolina (private) -- no response
New Mexico -- response received, but didn't "feel comfortable" answering questions.
...
plot_usmap(data = pg_sn, values = "parent_notification_combo", regions = "states") +
  ...
  labs(title = "Parent/Guardian and School Notification Requirements for NIL Policies", fill = "Requirement") +
 theme(
...
Notes:
Specify which states don't have NIL in the legend.
- Maryland: Neither are required (red).
