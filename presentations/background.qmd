...
Below, I've loaded the draft data that I'll be using for my analysis. The grade data will involve using ChatGPT to take the grades from the URL and turn them into a CSV format that I can merge to the larger combined data set. 
